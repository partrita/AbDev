...
np.savetxt(
    ...
    delimiter=",",
    fmt="%s",
    header="Name,ACSINS_transformed,AS,BVP,CIC_transformed,CSI_transformed,ELISA,HIC,HEK,PSR,SGAC_transformed,SMAC_transformed,Tm",
    comments="",
)
